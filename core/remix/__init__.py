...
def generate_sequence(
    ...
    *,
    ...
    """Compatibility dispatcher over the algorithm registry.

    Removal condition: callers pass registry parameters to
    :func:`run_registry_algorithm` or ``core.spine.sequences.generate_sequence``
    directly. Kept for the pre-registry keyword contract (``direction``,
    ``no_color_handling``, ``seed=0`` meaning random).
