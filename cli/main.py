...
def register_commands() -> None:
    ...
    from cli.commands import detect, project, analyze, transcribe, export, youtube, sequence, runtime
    ...
    from cli.commands.import_images import import_images
    ...
    cli.add_command(import_images)
    cli.add_command(export.export)
    cli.add_command(sequence.sequence)
