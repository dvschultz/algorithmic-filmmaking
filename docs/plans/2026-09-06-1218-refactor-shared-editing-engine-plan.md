...
transformed-clip prerender artifacts, execution pins for referenced inputs, and
...
without automatic reuse. Transformed-clip prerenders remain to be migrated.
